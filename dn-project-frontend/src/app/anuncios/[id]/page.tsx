                    ...
                    <div className="w-full h-full grid grid-cols-5">
                        ...
                        <Card className="col-span-3">
                            ...
                            <CardContent className="grid grid-cols-2 gap-1 text-center">
                                <div className="p-0.5 border-1 flex justify-center items-center border-primary-2 rounded-md">{details.listing_type == "motorcycle" ? <Motorbike className="h-4 w-4 mr-1 text-primary-2" /> : <Car className="h-4 w-4 mr-1 text-primary-2" />}<p>Categoria: {listingTypes[details.listing_type] || details.listing_type}</p></div>
                                <div className="p-0.5 border-1 flex justify-center items-center border-primary-2 rounded-md"><Gem className="h-4 w-4 mr-1 text-primary-2" />  <p>Marca: {details.vehicles.brand}</p></div>
                                <div className="p-0.5 border-1 flex justify-center items-center border-primary-2 rounded-md"><KeySquare className="h-4 w-4 mr-1 text-primary-2" /> <p>Modelo: {details.vehicles.model}</p></div>
                                <div className="p-0.5 border-1 flex justify-center items-center border-primary-2 rounded-md"><CalendarDays className="h-4 w-4 mr-1 text-primary-2" /> <p>Ano: <span className="font-space">{details.vehicles.year}</span></p></div>
                                <div className="p-0.5 border-1 flex justify-center items-center border-primary-2 rounded-md"><Radar className="h-4 w-4 mr-1 text-primary-2" /> <p>Quilometragem: <span className="font-space">{details.vehicles.mileage}</span></p></div>
                                <div className="p-0.5 border-1 flex justify-center items-center border-primary-2 rounded-md"><Fuel className="h-4 w-4 mr-1 text-primary-2" /> <p>Combustível: {fuelTypes[details.vehicles.fuel_type] || details.vehicles.fuel_type}</p></div>
                            </CardContent>
                        </Card>
                    </div>
                </>
